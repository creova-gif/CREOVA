...
const translations = {
  en: {
    ...
    'nav.seen.tag': 'Storytelling app',
    'nav.seen.cta': 'Learn more',
    'nav.verse.tag': 'The clothing label',
    'nav.verse.shop': 'Shop the capsule',
    'nav.verse.digital': 'Digital products',
    'nav.studio.tag': 'The creative agency',
    ...
    'contact.book.btn.chat': 'Chat with Support First',
    ...
    'shop.tab.apparel': 'Apparel',
    'shop.tab.digital': 'Digital',
    ...
    'footer.contact.rating': 'Leave us a Google review',
    ...
    'home.hero.body': 'Photography, video and brand work for BIPOC-led founders, organizations and cultural events across the Niagara Region and Ontario — documentary-real, premium-finished, and made by a team that reflects the people in front of the lens.',
    ...
    'home.seen.badge': 'Also from CREOVA · In development',
    'home.seen.desc': 'SEEN is CREOVA\'s digital storytelling platform — where Indigenous, Black Canadian, francophone and immigrant voices own their stories, and audiences find the authentic Canada mainstream platforms miss.',
    'home.seen.features': 'Multilingual · Creator-owned · Culture-first',
    'home.seen.cta': 'Learn about SEEN',
    'home.seen.f1.label': 'Creator-Owned',
    'home.seen.f1.desc': 'Storytellers keep their voice and their work.',
    'home.seen.f2.label': 'Multilingual',
    'home.seen.f2.desc': 'Built for Canada\'s real linguistic diversity.',
    'home.seen.f3.label': 'Culture-First',
    'home.seen.f3.desc': 'Authentic stories, not algorithmic noise.',
    'home.seen.f4.label': 'In Development',
    'home.seen.f4.desc': 'Beta launching end of 2026.',
  ...
  fr: {
    ...
    'nav.about': 'À propos',
    'nav.journal': 'Journal',
    'nav.booking': 'Réserver une Séance',
    'nav.book.call': 'Réserver un Appel',
    'nav.explore': 'Explorer',
    'nav.close': 'Fermer',
    'nav.group.studio': 'Studio',
    'nav.group.community': 'Communauté',
    'nav.seen.tag': 'Application de récits',
    'nav.seen.cta': 'En savoir plus',
    'nav.verse.tag': 'La marque vestimentaire',
    'nav.verse.shop': 'Magasiner la capsule',
    'nav.verse.digital': 'Produits numériques',
    'nav.studio.tag': 'L’agence créative',
    ...
    'contact.book.btn.chat': 'Discuter avec le Soutien d\'Abord',
    ...
    'shop.tab.apparel': 'Vêtements',
    'shop.tab.digital': 'Numérique',
    ...
    'footer.contact.rating': 'Laissez-nous un avis Google',
    ...
    'home.hero.body': 'Photographie, vidéo et design de marque pour les fondateurs, organisations et événements culturels dirigés par des BIPOC dans la région de Niagara et partout en Ontario — un travail documentaire au fini haut de gamme, réalisé par une équipe à l\'image des gens devant l\'objectif.',
    ...
    // SEEN Platform Teaser
    'home.seen.badge': 'Aussi de CREOVA · En développement',
    'home.seen.desc': 'SEEN est la plateforme numérique de récits de CREOVA — où les voix autochtones, noires canadiennes, francophones et immigrantes possèdent leurs histoires, et où le public découvre le vrai Canada que les grandes plateformes manquent.',
    'home.seen.features': 'Multilingue · Détenu par les créateurs · La culture d\'abord',
    'home.seen.cta': 'Découvrir SEEN',
    'home.seen.f1.label': 'Détenu par les créateurs',
    'home.seen.f1.desc': 'Les conteurs gardent leur voix et leur travail.',
    'home.seen.f2.label': 'Multilingue',
    'home.seen.f2.desc': 'Conçu pour la vraie diversité linguistique du Canada.',
    'home.seen.f3.label': 'La culture d\'abord',
    'home.seen.f3.desc': 'Des histoires authentiques, pas du bruit algorithmique.',
    'home.seen.f4.label': 'En développement',
    'home.seen.f4.desc': 'Bêta lancée fin 2026.',
