    ...
    <section className="py-24 relative overflow-hidden" style={{ backgroundColor: '#1A1A2E' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl max-w-3xl mx-auto leading-relaxed" style={{ color: '#E0E0E0' }}>
            {t('testimonials.sub')}
          </p>
        </motion.div>
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col md:flex-row items-start gap-6 mb-8">
                ...
                <div className="flex-1">
                  <h3 className="text-2xl md:text-3xl mb-2" style={{ color: '#F8F9FA' }}>
                    {testimonials[activeTestimonial].name}
                  </h3>
                  <p className="text-lg mb-1" style={{ color: '#D4A843' }}>
                    {testimonials[activeTestimonial].role}
                  </p>
                  <p className="text-sm flex items-center gap-1" style={{ color: '#E0E0E0' }}>
              ...
              {/* Quote */}
              <p className="text-xl md:text-2xl leading-relaxed mb-8" style={{ color: '#E0E0E0' }}>
        ...
        >
          <h3 className="text-2xl md:text-3xl mb-8" style={{ color: '#F8F9FA' }}>
