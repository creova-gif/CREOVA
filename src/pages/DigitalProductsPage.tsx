...
export function DigitalProductsPage({ embedded = false }: DigitalProductsPageProps = {}) {
  ...
  // Free resources for creatives and founders — the "taste" tier. Each pairs
  // with a deeper paid product below (a single contract vs. the full
  // onboarding kit; one moodboard layout vs. the full strategy workbook), so
  // giving these away doesn't cannibalize the paid line, it feeds it.
  const leadMagnets = [
    { id: 'contract-template', title: 'Freelance Client Contract Template', description: 'A ready-to-use service agreement for creatives and founders — scope of work, payment terms, and usage rights, in plain language.', fileType: 'Template', value: 'Free', icon: FileText, downloadUrl: '#' },
    { id: 'moodboard-template', title: 'Moodboard Template', description: 'A clean, ready-to-fill moodboard layout to plan the direction for your next shoot, brand, or campaign.', fileType: 'Template', value: 'Free', icon: Palette, downloadUrl: '#' },
    { id: 'photoshoot-checklist', title: 'Photoshoot Preparation Checklist', description: 'What to bring, how to pose, and styling tips — everything to walk into your session ready.', fileType: 'PDF', value: 'Free', icon: Camera, downloadUrl: '#' },
    { id: 'content-planning-template', title: 'Monthly Content Planning Template', description: 'A simple template to plan posts, themes, and captions a month at a time.', fileType: 'Template', value: 'Free', icon: Star, downloadUrl: '#' }
  ];
  ...
  const digitalProducts = [
    ...
    { id: 'social-media-templates', name: 'SOCIAL MEDIA TEMPLATES', price: 32, image: 'https://images.unsplash.com/photo-1521572089244-e5aaacacca6b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzb2NpYWwlMjBtZWRpYSUyMHRlbXBsYXRlJTIwbW9ja3VwfGVufDF8fHx8MTc2MzIyODk0MHww&ixlib=rb-4.1.0&q=80&w=1080', hoverImage: 'https://images.unsplash.com/photo-1521572089244-e5aaacacca6b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzb2NpYWwlMjBtZWRpYSUyMHRlbXBsYXRlJTIwbW9ja3VwfGVufDF8fHx8MTc2MzIyODk0MHww&ixlib=rb-4.1.0&q=80&w=1080', type: 'Templates', description: '20 Instagram, TikTok, and Pinterest templates designed for BIPOC entrepreneurs', includes: '20 templates · Story & post layouts · Reels covers', category: 'content', badge: 'NEW' },
    ...
    <div style={{ backgroundColor: '#F8F9FA' }}>
      ...
      */}
          ...
          <div className="grid md:grid-cols-[1fr_auto] gap-0 items-center py-16 sm:py-24">
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="text-[10px] tracking-[0.5em] uppercase" style={{ color: '#D4A843' }}>CREOVA Digital Studio</span>
                <span className="text-[9px] tracking-[0.3em] uppercase px-2 py-0.5 rounded-sm ml-2" style={{ backgroundColor: 'rgba(212,168,67,0.12)', border: '1px solid rgba(212,168,67,0.25)', color: '#D4A843' }}>November 2026</span>
              </motion.div>
              ...
              <h1 className="leading-none">
                ...
                <motion.span
                  ...
                  style={{ fontSize: 'clamp(72px, 13vw, 180px)', color: '#F8F9FA' }}
                >
                  Digital.
                </motion.span>
            ...
            >
              ...
              <div className="mt-1 flex items-center gap-2 px-1">
                ...
                <span className="text-[10px] tracking-wide" style={{ color: 'rgba(248,249,250,0.25)' }}>Launching November 2026</span>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="sticky z-40" style={{ top: '64px', backgroundColor: '#121212', borderBottom: '1px solid rgba(212,168,67,0.15)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <button className="hidden md:flex items-center gap-1 text-xs tracking-widest pr-2 flex-shrink-0" style={{ color: '#777777' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-10">
            {filteredProducts.map((product, index) => (
              ...
              >
                {/* Image area */}
                <div className="relative aspect-[4/3] mb-3 overflow-hidden" style={{ backgroundColor: '#F8F9FA' }}>
                  <img
                    src={product.image}
                    alt={product.name}
                    loading="lazy"
                ...
                <div className="space-y-1">
                  ...
                  {hoveredProduct === product.id && (
                    <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} className="pt-1">
                      <p className="text-[10px] leading-relaxed" style={{ color: '#777777' }}>{product.description}</p>
                    </motion.div>
                  )}
                </div>
              </motion.div>
      ...
      <section className="py-16 relative overflow-hidden" style={{ backgroundColor: '#121212' }}>
        ...
        <div className="absolute inset-0 pointer-events-none" style={{
          background: 'radial-gradient(ellipse 60% 80% at 50% 50%, rgba(212,168,67,0.04) 0%, transparent 65%)'
        }} />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
            {[
              ...
              <div key={i}>
                ...
                <h3 className="text-[10px] tracking-[0.4em] mb-2 uppercase" style={{ color: '#F8F9FA' }}>{item.title}</h3>
              ...
              {leadMagnets.map((magnet) => (
                ...
                >
                  ...
                  <div className="px-5 py-3 flex items-center justify-between" style={{ backgroundColor: '#121212' }}>
                    ...
                    <span className="text-xs" style={{ color: '#F8F9FA' }}>{magnet.value} value</span>
                  </div>
                  ...
                  <div className="p-5">
                    ...
                    <button
                      ...
                      style={{ backgroundColor: 'rgba(212,168,67,0.12)', color: '#777777', cursor: 'not-allowed', border: '1px solid rgba(212,168,67,0.2)' }}
                      disabled
                    >
