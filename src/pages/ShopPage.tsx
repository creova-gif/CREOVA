...
export function ShopPage() {
  ...
  const products = [
    ...
    { id: 'bucket-hat-seen', name: 'VERSE BUCKET HAT', price: 38, image: 'https://images.unsplash.com/photo-1581688307440-8bb9ad534fd0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidWNrZXQlMjBoYXQlMjBwcm9kdWN0JTIwZmxhdHxlbnwxfHx8fDE3NjMyNTI2Njh8MA&ixlib=rb-4.1.0&q=80&w=1080', hoverImage: 'https://images.unsplash.com/photo-1581688307440-8bb9ad534fd0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidWNrZXQlMjBoYXQlMjBwcm9kdWN0JTIwZmxhdHxlbnwxfHx8fDE3NjMyNTI2Njh8MA&ixlib=rb-4.1.0&q=80&w=1080', sizes: ['One Size'], colors: ['Jet Black', 'Sahara Beige', 'Olive Green', 'Burnt Sienna', 'Earth Clay'], category: 'accessories', badge: 'NEW SEASON', description: 'Bucket hat from the VERSE collection' },
    ...
    <div style={{ backgroundColor: '#F8F9FA' }}>
      {activeCollection === 'apparel' && (
        <PageSEO
          ...
          description="VERSE by CREOVA — Vol. 01 Fall/Winter 2026 capsule collection. 14 styles of culturally rich streetwear, footwear and accessories. Pre-order now, ships November 2026."
          path="/shop"
      ...
      >
        <span className="flex items-center justify-center gap-3">
          ...
          Pre-Order Now — VERSE Fall/Winter Capsule · Vol. 01 · Ships November 2026
